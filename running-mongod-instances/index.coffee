command: "ps -ef | grep 'mongod ' | grep -v grep"
...
render: -> """
  <div class="container">
    <div class="widget-title">Running mongod instances</div>
...
update: (output, domElement) ->
  ...
  domElement.innerHTML = '<div class="container"><div class="widget-title">Running mongod instances</div><div id="formulae" class="list"></div></div>'
  ...
  if formulae.length == 0
    ...
    addFormula " UID   PID  PPID   C STIME   TTY           TIME CMD"
